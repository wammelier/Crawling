...
//    driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[1]/div/label/input")).click();
    driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div[2]/div/div/div[2]/div"));

//		WebDriverWait wait = new WebDriverWait(driver,10000);

    //selenium에 제공되는 By Class를 이용하여 CssSeletor로 Css접근
    By picture = By.cssSelector("#app > div:nth-child(2) > div:nth-child(3) > div > div > div.results--efirA > div > div > div > div > div > a > img");
